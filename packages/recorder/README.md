...
This README covers the extension itself. For the overall project, see the [repo root README](../../README.md). For the full product spec, see [`docs/prd.md`](../../docs/prd.md).
