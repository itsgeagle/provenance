...
export function Header() {
  const { bundles, selectedBundleId, selectBundle, clearBundle, loadBundleFiles } = useBundle();
  ...
  return (
    <header
      data-testid="header"
      className="sticky top-0 z-10 flex items-center justify-between border-b bg-background px-6 py-3 gap-4"
    >
